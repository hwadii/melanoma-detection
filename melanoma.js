...
const lowerBound = new cv.Vec3(5, 90, 0); // light brown
const upperBound = new cv.Vec3(15, 180, 255); // dark brown
...
(async () => {
  ...
  conts.forEach((cont, i) => {
    ...
    // img.putText(`${i + 1}`, new cv.Point2(rect.x, rect.y + rect.h), cv.FONT_HERSHEY_SIMPLEX, 1, new cv.Vec3(0, 255, 0));
  });
