...
const colors = {
  ...
  red: [new Vec3(0, 100, 100), new Vec3(10, 255, 255)],
...
const masks = {
  ...
  lightBrown: {lowerBound: colors.lightBrown[0], upperBound: colors.lightBrown[1]},
  darkBrown: {lowerBound: colors.darkbrown[0], upperBound: colors.darkbrown[1]},
